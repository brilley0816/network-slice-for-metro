...
* [This repository is about network slicing build using oai/5gc and with oai/ran-simulator, ueransim, 5gnbsim]

* [There are thress different network slices with NSSAI 2 2 , 3 3, 4 4 and attached with one or with UEs] 
